...
import { AlertCircle, Download, FolderOpen, Settings2, Sparkles, Terminal } from 'lucide-react';
...
function FieldGroup({
  ...
  return (
    ...
    <div className="mp-install-field">
      ...
      {hint && <p className="mp-install-hint">{hint}</p>}
...
export function MarketplaceScriptInstallPanel({
  ...
  return (
    ...
    <section className="mp-script-install">

      <div className="mp-script-install-header">

        <div className="mp-script-install-intro">

          <span className="mp-script-install-badge">
          ...
          <h2 className="mp-script-install-title">Install to server</h2>

          <p className="mp-script-install-subtitle">
      ...
      <div className="mp-install-preview">
      ...
      <div className="mp-install-section">

        <p className="mp-install-section-title">
        ...
        <div className="mp-install-grid mp-install-grid--aside">
          ...
          <FieldGroup label="Version" hint="Release or tag to download">
            ...
            <SelectControl className="mp-install-select" value={githubRef} onChange={(e) => setGithubRef(e.target.value)}>
      ...
      <div className="mp-install-section">
        ...
        <div className="mp-install-grid mp-install-grid--aside">
          ...
          <FieldGroup label="Start command">
            ...
            <SelectControl className="mp-install-select" value={cfgAction} onChange={(e) => setCfgAction(e.target.value as 'ensure' | 'start')}>
      ...
      {!canInstall && (
        ...
        <p className="mp-install-permission">You don&apos;t have permission to install marketplace resources.</p>
