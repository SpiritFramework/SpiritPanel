...
const EVENT_META: Record<string, { label: string; icon: LucideIcon; color: string }> = {
  ...
  'auth.discord.linked': { label: 'Discord linked', icon: UserPlus, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'auth.profile.updated': { label: 'Profile updated', icon: Settings, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'admin.server.updated': { label: 'Server updated', icon: Settings, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.reinstall': { label: 'Server reinstall', icon: RotateCw, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  'admin.server.reinstall': { label: 'Server reinstall', icon: RotateCw, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.allocation.primary': { label: 'Primary port changed', icon: Network, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'admin.egg.imported': { label: 'Egg imported', icon: Egg, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  'admin.settings.updated': { label: 'Settings changed', icon: Settings, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.command': { label: 'Console command', icon: Terminal, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.file.compress': { label: 'Archive created', icon: Archive, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  'server.file.decompress': { label: 'Archive extracted', icon: Archive, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.settings.updated': { label: 'Settings changed', icon: Settings, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.backup.created': { label: 'Backup started', icon: Archive, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  'server.backup.download': { label: 'Backup downloaded', icon: Download, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  'server.backup.restore': { label: 'Backup restored', icon: RotateCw, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
  ...
  'server.schedule.executed': { label: 'Schedule ran', icon: CalendarClock, color: 'text-[var(--accent)] bg-[var(--accent-muted)]' },
